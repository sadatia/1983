...
packages_install(){
    ...
    apt-get install -y --force-yes php7.0-cli curl>/dev/null 2>&1
...
fos_install(){
    ...
    wget https://www.dropbox.com/s/s08e6lbjybjv9ri/fos-streaming_unpack_x84_64.tar.gz -O /home/fos-streaming/fos-streaming_unpack_x84_64.tar.gz  > /dev/null 2>&1
